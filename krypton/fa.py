...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--trans", default="", help="Comma separated translation pairs.")
    parser.add_argument("--ngrams", action="store_true", help="Show bigram frequencies.")
    parser.add_argument("--doubles", action="store_true", help="Show double letter frequencies.")
    parser.add_argument(
        "--black", action="store_true", help="Render remaining ciphertext in black."
    )
    ...
    if args.trans:
        ...
        for k, v in pairs:
            ...
            if k in t_map:
                print("{}[!] Repeated translation key found: {}{}".format(RED, k, NC))
                sys.exit(42)
            elif v in t_map.values():
                print("{}[!] Repeated translation target found: {}{}".format(RED, v, NC))
                sys.exit(42)
        ...
        if remaining:
            print("{}[ ] Remaining characters: {}{}\n".format(BLACKBG, "".join(remaining), NC))

        print("".join(t_map.get(c, fg + c + NC) for c in ciphertext.lower()))
